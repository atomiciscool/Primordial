...
local PlacesData = game:HttpGet("https://raw.githubusercontent.com/atomiciscool/Primordial/main/src/places.json")
...
if supported then
    loadstring(game:HttpGet("https://raw.githubusercontent.com/atomiciscool/Primordial/main/src/main.lua"))()
else
